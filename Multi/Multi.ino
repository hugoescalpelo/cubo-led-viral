...
const int SENSOR_READ = 500;//Determina el tiempo de lectura del sensor a 1 segundo
...
void setup() {
  ...
  FastLED.addLeds<LED_TYPE,D3,COLOR_ORDER>(leds2, NUM_LEDS_PER_STRIP).setCorrection(TypicalLEDStrip);
  FastLED.addLeds<LED_TYPE,D4,COLOR_ORDER>(leds2, NUM_LEDS_PER_STRIP).setCorrection(TypicalLEDStrip);
  FastLED.addLeds<LED_TYPE,D5,COLOR_ORDER>(leds2, NUM_LEDS_PER_STRIP).setCorrection(TypicalLEDStrip);
  FastLED.addLeds<LED_TYPE,D6,COLOR_ORDER>(leds2, NUM_LEDS_PER_STRIP).setCorrection(TypicalLEDStrip);
  FastLED.addLeds<LED_TYPE,D8,COLOR_ORDER>(leds2, NUM_LEDS_PER_STRIP).setCorrection(TypicalLEDStrip);
...
void confetti() 
{
  ...
  fadeToBlackBy( leds0, NUM_LEDS_PER_STRIP, 5);
  fadeToBlackBy( leds1, NUM_LEDS_PER_STRIP, 5);
  fadeToBlackBy( leds2, NUM_LEDS_PER_STRIP, 5);
  fadeToBlackBy( leds3, NUM_LEDS_PER_STRIP, 5);
  fadeToBlackBy( leds4, NUM_LEDS_PER_STRIP, 5);
  fadeToBlackBy( leds5, NUM_LEDS_PER_STRIP, 5);
  fadeToBlackBy( leds6, NUM_LEDS_PER_STRIP, 5);
  fadeToBlackBy( leds7, NUM_LEDS_PER_STRIP, 5);
  int pos = random16(NUM_LEDS_PER_STRIP);
  leds0[pos] += CHSV( gHue0 + random8(16), 200, 255);
  pos = random16(NUM_LEDS_PER_STRIP);
  leds1[pos] += CHSV( gHue1 + random8(16), 200, 255);
  pos = random16(NUM_LEDS_PER_STRIP);
  leds2[pos] += CHSV( gHue2 + random8(16), 200, 255);
  pos = random16(NUM_LEDS_PER_STRIP);
  leds3[pos] += CHSV( gHue3 + random8(16), 200, 255);
  pos = random16(NUM_LEDS_PER_STRIP);
  leds4[pos] += CHSV( gHue4 + random8(16), 200, 255);
  pos = random16(NUM_LEDS_PER_STRIP);
  leds5[pos] += CHSV( gHue5 + random8(16), 200, 255);
  pos = random16(NUM_LEDS_PER_STRIP);
  leds6[pos] += CHSV( gHue6 + random8(16), 200, 255);
  pos = random16(NUM_LEDS_PER_STRIP);
  leds7[pos] += CHSV( gHue7 + random8(16), 200, 255);
  //addGlitter(10);
}
